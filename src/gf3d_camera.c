...
void gf3d_camera_set_position(Vector3D position, Vector3D add)
{
    gf3d_camera.position.x = -position.x + add.x;
    gf3d_camera.position.y = -position.y + add.y;
    gf3d_camera.position.z = -position.z + add.z;
}
